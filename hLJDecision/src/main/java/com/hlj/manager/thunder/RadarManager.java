...
public class RadarManager {
	...
	public void loadImagesAsyn(Map<String, StrongStreamDto> radars, RadarListener listener) {
		if (mLoadThread != null) {
			mLoadThread.cancel();
			mLoadThread = null;
		}
	...
	private class LoadThread extends Thread {
		...
		private LoadThread(Map<String, StrongStreamDto> radars, RadarListener listener) {
			this.radars = radars;
		...
		private String decodeFromUrl(String url, String startTime){
		    try {
				...
				try {
					File file = new File(getDir() + "/radar"+startTime+".png");
