...
public class HReserveCityActivity extends BaseActivity implements View.OnClickListener, AMapLocationListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hactivity_reserve_city);
        mContext = this;
        showDialog();
        initWidget();
        initListView();
