...
public class RelativeHumidityActivity extends BaseActivity implements OnClickListener{
	...
	private String colorType = null;//定义数值颜色类型
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.relative_humidity);
		mContext = this;
		initWidget();
