 ...
 * 城市选择
 */
class SelectCityAdapter constructor(context: Context?, private var mArrayList: MutableList<CityDto>) : BaseAdapter() {
    ...
    override fun getView(position: Int, view: View?, parent: ViewGroup?): View? {
        ...
        if (convertView == null) {
            convertView = mInflater!!.inflate(R.layout.adapter_select_city, null)
            mHolder = ViewHolder()
