...
public class CloudManager {
	...
	public void loadImagesAsyn(Map<String, StrongStreamDto> radars, CloudListener listener) {
		if (mLoadThread != null) {
			mLoadThread.cancel();
			mLoadThread = null;
		}
	...
	private class LoadThread extends Thread {
		...
		private LoadThread(Map<String, StrongStreamDto> radars, CloudListener listener) {
			this.radars = radars;
		...
		private String decodeFromUrl(String url, String startTime){
		    try {
				...
				try {
					File file = new File(getDir() + "/cloud"+startTime+".png");
