...
public class SimpleDownloader implements Downloader {
	...
	public byte[] download (String urlString, Crypter crypter){
		if (urlString == null)
			return null;
	...
	private byte[] getFromFile(File file, Crypter crypter) {
		if(file == null) return null;
		
		InputStream fis = null;
		try {
			if (crypter != null) {
				fis = crypter.decrypt(file);
			} else {
